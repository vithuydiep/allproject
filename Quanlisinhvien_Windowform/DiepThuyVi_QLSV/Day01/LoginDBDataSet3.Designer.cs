...
namespace Day01.LoginDBDataSet3TableAdapters {
...
SELECT id, fname, lname, bdate, gender, phone, address, picture FROM std WHERE (id = @id)";
        ...
        public virtual int Fill(LoginDBDataSet3.stdDataTable dataTable) {
        ...
        public virtual LoginDBDataSet3.stdDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDBDataSet3.stdDataTable dataTable = new LoginDBDataSet3.stdDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDBDataSet3.stdDataTable dataTable) {
