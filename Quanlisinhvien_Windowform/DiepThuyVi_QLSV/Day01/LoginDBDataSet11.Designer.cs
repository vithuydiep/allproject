...
namespace Day01.LoginDBDataSet1TableAdapters {
...
SELECT id, fname, lname, bdate, gender, phone, address, picture FROM std WHERE (id = @id)";
        ...
        public virtual int Fill(LoginDBDataSet1.stdDataTable dataTable) {
        ...
        public virtual LoginDBDataSet1.stdDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDBDataSet1.stdDataTable dataTable = new LoginDBDataSet1.stdDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDBDataSet1.stdDataTable dataTable) {
