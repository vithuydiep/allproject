...
namespace Day01.LoginDBDataSetTableAdapters {
...
SELECT id, fname, lname, bdate, gender, phone, address, picture FROM std WHERE (id = @id)";
        ...
        public virtual int Fill(LoginDBDataSet.stdDataTable dataTable) {
        ...
        public virtual LoginDBDataSet.stdDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDBDataSet.stdDataTable dataTable = new LoginDBDataSet.stdDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDBDataSet.stdDataTable dataTable) {
