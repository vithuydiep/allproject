...
namespace Day01.LoginDBDataSet2TableAdapters {
...
SELECT id, fname, lname, bdate, gender, phone, address, picture FROM std WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Day01.Properties.Settings.Default.LoginDBConnectionString;
        }
        ...
        public virtual int Fill(LoginDBDataSet2.stdDataTable dataTable) {
        ...
        public virtual LoginDBDataSet2.stdDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDBDataSet2.stdDataTable dataTable = new LoginDBDataSet2.stdDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDBDataSet2.stdDataTable dataTable) {
