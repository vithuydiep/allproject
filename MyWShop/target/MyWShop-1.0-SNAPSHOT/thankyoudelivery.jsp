<%-- 
    Document   : thankyoudelivery
    Created on : Dec 17, 2020, 10:32:35 PM
    Author     : Vi Diep
--%>
                                                    ...
                                                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                        <tbody><tr>
                                                                <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                                    ...
                                                                    <img align="center" alt="" src="https://mcusercontent.com/6e79677208574ebfa7a7c0bea/images/7b1fa851-2613-4a0b-a37a-3f1656b60860.png" width="344" style="max-width:344px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                ...
                                                <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                                ...
                                                                <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #E74A23;">

                                                                    <div style="text-align: center;"><strong>Please check your email</strong> to review your order.</div>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 18px;">
                                                                    <a class="mcnButton " title="Continue to homepage" href="index.jsp" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Continue to homepage</a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
