...
namespace TestFramework.NvdatasetTableAdapters {
...
SELECT id, firstname, lastname, phone, gender, addr, picture, idpos FROM Staff WHERE (id = @id)";
        ...
        public virtual int Fill(Nvdataset.StaffDataTable dataTable) {
        ...
        public virtual Nvdataset.StaffDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Nvdataset.StaffDataTable dataTable = new Nvdataset.StaffDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Nvdataset.StaffDataTable dataTable) {
