...
SELECT id, name, type, price, description, inputday, amount, curnumber, picture FROM Product WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [id] = @id, [name] = @name, [type] = @type, [price] = @price, [description] = @description, [inputday] = @inputday, [amount] = @amount, [curnumber] = @curnumber, [picture] = @picture WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_type = 1 AND [type] IS NULL) OR ([type] = @Original_type)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_inputday = 1 AND [inputday] IS NULL) OR ([inputday] = @Original_inputday)) AND ((@IsNull_amount = 1 AND [amount] IS NULL) OR ([amount] = @Original_amount)) AND ((@IsNull_curnumber = 1 AND [curnumber] IS NULL) OR ([curnumber] = @Original_curnumber)));
SELECT id, name, type, price, description, inputday, amount, curnumber, picture FROM Product WHERE (id = @id)";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_type, global::System.Nullable<double> Original_price, global::System.Nullable<global::System.DateTime> Original_inputday, global::System.Nullable<int> Original_amount, global::System.Nullable<int> Original_curnumber) {
            ...
            if ((Original_inputday.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((System.DateTime)(Original_inputday.Value));
            }
            else {
            ...
            if ((Original_curnumber.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[12].Value = ((int)(Original_curnumber.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((Original_inputday.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[17].Value = ((System.DateTime)(Original_inputday.Value));
            }
            else {
            ...
            if ((Original_curnumber.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((int)(Original_curnumber.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string type, global::System.Nullable<double> price, string description, global::System.Nullable<global::System.DateTime> inputday, global::System.Nullable<int> amount, global::System.Nullable<int> curnumber, byte[] picture, int Original_id, string Original_name, string Original_type, global::System.Nullable<double> Original_price, global::System.Nullable<global::System.DateTime> Original_inputday, global::System.Nullable<int> Original_amount, global::System.Nullable<int> Original_curnumber) {
            return this.Update(Original_id, name, type, price, description, inputday, amount, curnumber, picture, Original_id, Original_name, Original_type, Original_price, Original_inputday, Original_amount, Original_curnumber);
        }
    }
